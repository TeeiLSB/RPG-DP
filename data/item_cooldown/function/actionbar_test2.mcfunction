...
title @s actionbar ["",\
"\uF827\uF825\uF824\uF822",{"score":{"name":"@s","objective":"HP"},"font":"shift_23px","color":"red"},{"text":".","font":"shift_23px","color":"red"},{"score":{"name":"@s","objective":"hpdec"},"font":"shift_23px","color":"red"},{"text":"/","font":"shift_23px","color":"red"},{"score":{"name":"@s","objective":"maxhpdisplay"},"font":"shift_23px","color":"red"},\
"\uF82F",\
