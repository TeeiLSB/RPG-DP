...
execute if entity @s[tag=mobs,type=!player] at @s run function status:display/dataget
execute if entity @s[tag=mobs,type=!player] at @s run function status:display/dmg_dsp
