...
# レベル再計算開始
function player:leveling/sword/recalc
...
# sword threw cd
scoreboard players set @s throw_sword 250
...
scoreboard players set @s blockcounter 300
...
execute unless score @s sword_level matches 0 unless score @s prev_sword_level = @s sword_level run function player:leveling/sword/levelup_msg
