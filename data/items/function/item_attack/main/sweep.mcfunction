...
execute as @e[tag=sword_sweep,tag=mobs] on attacker if entity @s[predicate=items:vampiresword] run function items:item_attack/weapons/vampiresword_blood_drain
