...
execute unless predicate items:magic_staff run scoreboard players set @s chant_time 0
execute unless predicate items:magic_staff run scoreboard players set @s magic_prog 0
...
execute if predicate items:magic_staff run function magic:magic_staff_select/main



execute unless predicate items:magic_staff run scoreboard players reset @s reqmp

execute if predicate items:magic_staff run function magic:chant/tick
...
# execute if predicate items:magic_staff run title @s title ok
