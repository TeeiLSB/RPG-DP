...
execute if score @s selected_mslot_id matches 1 run function magic:cast/timer/_ {"value":"5"}
execute if score @s selected_mslot_id matches 2 run function magic:cast/timer/_ {"value":"25"}
execute if score @s selected_mslot_id matches 3 run function magic:cast/timer/_ {"value":"5"}
