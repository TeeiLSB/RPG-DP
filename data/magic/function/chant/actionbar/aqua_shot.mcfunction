...
scoreboard players set @s magicbook_damage 15
...
execute if items entity @s weapon.mainhand burn_pottery_sherd[custom_data~{magic_staff:true}] \
    run item modify entity @s weapon.mainhand {function: "set_custom_model_data",flags:{values:[0b,0b,1b,0b,0b],mode:"replace_all"}}