...
# 周囲のmob 2体までにダメージ処理
execute on attacker run scoreboard players operation @e[tag=mobs,sort=nearest,distance=..2.5,scores={HurtTime=0},limit=2,tag=!lightning_exclude] health -= @s mgcdmg
