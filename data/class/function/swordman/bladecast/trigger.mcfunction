execute at @s anchored eyes positioned ^ ^ ^1.25 positioned ~-0.125 ~-0.125 ~-0.125 summon armor_stand run function class:swordman/bladecast/armor_stand_setting
...
execute at @s anchored eyes positioned ^ ^ ^1.25 positioned ~-0.125 ~-0.125 ~-0.125 summon minecraft:item_display run function class:swordman/bladecast/sword_setting with storage player: sword

execute at @s anchored eyes positioned ^ ^ ^1.25 positioned ~-0.125 ~-0.125 ~-0.125 summon interaction run function class:swordman/bladecast/interaction_setting
execute at @s anchored eyes positioned ^ ^ ^1.25 positioned ~-0.125 ~-0.125 ~-0.125 summon interaction run function class:swordman/bladecast/interaction_setting2
