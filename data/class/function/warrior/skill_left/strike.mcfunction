playsound block.anvil.place master @s ~ ~ ~ 1 0.25
scoreboard players set @s Warrior.ProgTimer 0

tag @s add Warrior.Skill_Used
execute at @s as @e[distance=..3,tag=mobs,nbt={HurtTime:0s},limit=10] at @s run function class:warrior/skill_left/hit_strike
