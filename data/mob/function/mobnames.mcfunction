execute if entity @s[tag=Name.Dummy] run data modify storage lib: hp.name set value "サンドバック"


execute if entity @s[tag=Name.Husk] run data modify storage lib: hp.name set value "ハスク"
execute if entity @s[tag=Name.IronGolem] run data modify storage lib: hp.name set value "アイアンゴーレム"
